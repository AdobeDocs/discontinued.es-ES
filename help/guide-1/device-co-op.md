...
title: "[!DNL Device Co-op] preguntas frecuentes sobre el fin de vida útil"
...
# [!DNL Device Co-op] preguntas frecuentes sobre el fin de vida útil

Este documento proporciona respuestas a las preguntas más frecuentes sobre [!DNL Adobe Experience Cloud Device Co-op] plan de fin de vida útil (EOL). Cuando este plan entre en vigor, Adobe proporcionará un aviso anticipado en la [Notas de la versión del Experience Cloud](https://experienceleague.adobe.com/docs/release-notes/experience-cloud/current.html) y [Actualización de producto prioritaria](https://www.adobe.com/subscription/priority-product-update.html).
...
- [!DNL Audience Manager] [Destinos basados en personas](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/destinations/people-based/people-based-destinations-overview.html).
